...
function sizeChk(){
    ...
    if ($(window).width()<768) {
        $('.sc-project2 .project-slide .swiper-slide a').off('mouseover mouseleave');
        
    } else {
        $('.sc-project2 .project-slide .swiper-slide a').off('mouseover mouseleave');
        
        $('.sc-project2 .project-slide .swiper-slide a').mouseover(function(){
        ...
        $('.sc-project2 .project-slide .swiper-slide a').mouseleave(function(){
